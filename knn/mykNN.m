function [Confusion_Matrix]=mykNN(TrainData,TestData,LabelsTrainData,LabelsTestData,Labels,k,Confusion_Matrix)
%Ntagiou Anna 432
%{
...
NNeighbors=zeros(k,l,m);                                                    %Initialization of matrix NNeighboors KxLxM      
...
for i=1:m                                                                   %who has the predicted classes
    counter0=0;
    counter1=0;
    for h=1:k                                                               %Counts the number of class=2(counter0) 
